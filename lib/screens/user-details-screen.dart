...
class UserDetailScreen extends StatelessWidget {
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildUserInfoRow('Username', userData['name'], Icons.person),
                      _buildDivider(),
                      _buildUserInfoRow('Email', userData['email'], Icons.email),
                      _buildDivider(),
                      _buildUserInfoRow('Phone', userData['phone'], Icons.phone),
                      _buildDivider(),
  ...
  Widget _buildUserInfoRow(String title, String value, IconData icon) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, color: AppColor().colorRed, size: 26),
        SizedBox(width: 10),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
